...
const CITY_ASSET_MAP = {
  mumbai: ['BRIDGE_001', 'PIPE_042', 'ROAD_012', 'TRANSFORMER_007', 'HOSPITAL_001'],
...
const TYPE_ORDER = ['Bridge', 'Pipeline', 'Road', 'Transformer', 'Hospital', 'Other']
...
const S = {
  ...
  h3: {
    fontSize: '13px', fontWeight: '600', color: '#94a3b8', margin: '0 0 12px',
...
const KPICard = ({ icon, title, value, sub, color }) => (
  <div style={{
    ...S.cardSm, display: 'flex', alignItems: 'flex-start',
    gap: '14px', flex: 1
  }}>
    <div style={{
  ...
  return (
    <div onClick={onClick} style={{
      ...
      <div style={{ marginTop: '12px' }}>
        <div style={{
          display: 'flex', height: '4px', borderRadius: '999px',
          overflow: 'hidden', gap: '2px'
        }}>
          {donutData.filter(d => d.value > 0).map((d, i) => (
            <div key={i} style={{
              background: d.color, flex: d.value,
    ...
    <ResponsiveContainer width="100%" height={200}>
      <BarChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
        ...
        <YAxis yAxisId="left" stroke="#334155" tick={{ fill: '#64748b', fontSize: 10 }}
          label={{
            value: '₹ Lakhs', angle: -90, position: 'insideLeft',
            fill: '#475569', fontSize: 9
          }} />
        <YAxis yAxisId="right" orientation="right" stroke="#334155"
          tick={{ fill: '#64748b', fontSize: 10 }}
          label={{
            value: 'CO₂ kg', angle: 90, position: 'insideRight',
            fill: '#475569', fontSize: 9
          }} />
        <Tooltip contentStyle={S.TT}
...
export default function CityComparison() {
  ...
  if (loading) return (
    <div style={{
      ...S.page, alignItems: 'center', justifyContent: 'center',
      height: '60vh'
    }}>
  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <div style={{
          height: '380px', borderRadius: '10px', overflow: 'hidden',
      ...
      <div>
        <h2 style={{ ...S.h2, fontSize: '17px', marginBottom: '14px' }}>
          ...
          <span style={{
            color: '#475569', fontSize: '12px', fontWeight: '400',
            marginLeft: '8px'
          }}>
            — live from MongoDB
          </span>
                      ...
                      <td style={{ padding: '8px 12px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <div style={{
                            ...
                            <div style={{
                              width: `${asset.risk_score}%`, height: '100%',
      ...
      <div style={{
        background: 'linear-gradient(135deg,#0f172a,#1a0a2e,#0a1628)',
