        ...
        <div className="gauge-container">
            <svg viewBox="0 0 200 130">
                ...
                <path d="M20,110 A80,80 0 0,1 180,110" fill="none"
                    stroke="rgba(255,255,255,0.05)" strokeWidth="18" strokeLinecap="round" />
                <path d="M20,110 A80,80 0 0,1 180,110" fill="none"
                    stroke="url(#gauge-gradient)" strokeWidth="14" strokeLinecap="round" />
                <line
                    x1={cx + 20 * Math.cos(rad)}          y1={cy - 20 * Math.sin(rad)}
                    x2={cx + needleRadius * Math.cos(rad)} y2={cy - needleRadius * Math.sin(rad)}
                    stroke={getColor(value)} strokeWidth="3" strokeLinecap="round"
                    filter="url(#needle-glow)"
                />
                <circle cx={cx} cy={cy} r="6"
                    fill="var(--bg-primary)" stroke={getColor(value)} strokeWidth="3" />
                <text x={cx} y={cy + 24} textAnchor="middle"
                    fill={getColor(value)} fontSize="20" fontWeight="800">
                    {value}
                </text>
